      ...
      <div className="h-full mx-auto max-w-5xl">
        <div className="mx-auto max-w-7xl px-4l lg:text-center sm:px-6 lg:px-8 pb-10">
          <div className="max-w-3xl mx-auto lg:max-w-none">
            <h2 className="text-5xl font-semibold tracking-tighter text-white text-center">
              Level up your{" "}
        ...
        <div className="items-start gap-2 mx-auto mt-12 flex flex-col lg:grid lg:grid-cols-3">
            ...
            <div className="flex flex-col">
              ...
              <ul className="flex flex-col gap-2 mt-12 text-sm text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  <p>Boost your productivity with Sheety</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0">
                    <svg
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p>Permanent access to the Sheety community</p>
                </li>
              </ul>
            </div>
            <div className="mt-8">
              <button className="flex items-center justify-center w-full h-10 px-4 py-2 text-sm font-semibold text-gray-600 transition-all bg-white border border-gray-300 rounded-lg">
                Get started
              </button>
            </div>
          </div>
          <div className="flex flex-col text-black justify-between h-full p-8 bg-[#cff245] rounded-3xl">
            <div className="flex flex-col">
              <div>
                <h3 className="mt-4 font-medium">Sheety Yearly License</h3>
              </div>
              ...
              <ul className="flex flex-col gap-2 mt-12 text-sm">
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mt-8">
              <button className="flex items-center justify-center w-full h-10 px-4 py-2 text-sm font-semibold transition-all bg-white border border-gray-300 rounded-lg text-gray-600">
                Get started
              </button>
            </div>
          </div>
